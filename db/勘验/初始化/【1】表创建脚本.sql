DROP TABLE IF EXISTS tab_count;
DROP TABLE IF EXISTS tab_role_operate;
DROP TABLE IF EXISTS tab_role_resource;
DROP TABLE IF EXISTS tab_acc_role;
DROP TABLE IF EXISTS tab_person;
DROP TABLE IF EXISTS tab_accounts;
DROP TABLE IF EXISTS tab_city;
DROP TABLE IF EXISTS tab_data_dict;
DROP TABLE IF EXISTS tab_operate;
DROP TABLE IF EXISTS tab_privilege;
DROP TABLE IF EXISTS tab_resource;
DROP TABLE IF EXISTS tab_role;
drop table IF EXISTS tab_navigation_bar;
...
drop table if exists tab_excellent_innovation;
