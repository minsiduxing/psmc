...
-- 信息发布之前列表用的是NEWS_TYPE，页面编辑用的是INFO_TYPE，目前改造都用INFO_TYPE，此处废弃
...
INSERT INTO TAB_DATA_DICT(ID,DICT_ID,DICT_NAME,REMARK,DICT_TYPE,ORDERNUM,DICT_NO,PARENT_DICT_TYPE) VALUES(1,'1501','关于介绍','信息分类',11,1,'INFO_TYPE',15);
INSERT INTO TAB_DATA_DICT(ID,DICT_ID,DICT_NAME,REMARK,DICT_TYPE,ORDERNUM,DICT_NO,PARENT_DICT_TYPE) VALUES(2,'1502','业务领域','信息分类',11,2,'INFO_TYPE',15);
INSERT INTO TAB_DATA_DICT(ID,DICT_ID,DICT_NAME,REMARK,DICT_TYPE,ORDERNUM,DICT_NO,PARENT_DICT_TYPE) VALUES(3,'1503','新闻动态','信息分类',11,3,'INFO_TYPE',15);
INSERT INTO TAB_DATA_DICT(ID,DICT_ID,DICT_NAME,REMARK,DICT_TYPE,ORDERNUM,DICT_NO,PARENT_DICT_TYPE) VALUES(4,'1504','联系我们','信息分类',11,4,'INFO_TYPE',15);

INSERT INTO TAB_DATA_DICT(ID,DICT_ID,DICT_NAME,REMARK,DICT_TYPE,ORDERNUM,DICT_NO,PARENT_DICT_TYPE) VALUES(5,'1601','合伙人','法律人员分类',12,1,'INFO_TYPE',16);
INSERT INTO TAB_DATA_DICT(ID,DICT_ID,DICT_NAME,REMARK,DICT_TYPE,ORDERNUM,DICT_NO,PARENT_DICT_TYPE) VALUES(6,'1602','专职律师','法律人员分类',12,2,'INFO_TYPE',16);
INSERT INTO TAB_DATA_DICT(ID,DICT_ID,DICT_NAME,REMARK,DICT_TYPE,ORDERNUM,DICT_NO,PARENT_DICT_TYPE) VALUES(7,'1603','辅助人员','法律人员分类',12,3,'INFO_TYPE',16);

-- delete from TAB_DATA_DICT where DICT_NO='PRODUCT_TYPE';
--
-- INSERT INTO TAB_DATA_DICT(ID,DICT_ID,DICT_NAME,REMARK,DICT_TYPE,ORDERNUM,DICT_NO,PARENT_DICT_TYPE) VALUES(1,'1601','合伙人','法律人员分类',12,1,'PRODUCT_TYPE',16);
-- INSERT INTO TAB_DATA_DICT(ID,DICT_ID,DICT_NAME,REMARK,DICT_TYPE,ORDERNUM,DICT_NO,PARENT_DICT_TYPE) VALUES(2,'1602','专职律师','法律人员分类',12,2,'PRODUCT_TYPE',16);
-- INSERT INTO TAB_DATA_DICT(ID,DICT_ID,DICT_NAME,REMARK,DICT_TYPE,ORDERNUM,DICT_NO,PARENT_DICT_TYPE) VALUES(3,'1603','辅助人员','法律人员分类',12,3,'PRODUCT_TYPE',16);


delete from tab_role_operate where operate_uuid in(select uuid from tab_operate where resource_uuid in('8e059c578c204fbbb29086aa72ec88f9','0b62d21d1ecd471f958d96b43471dcca','cd98d21d1ecd471f958d96b43471bbbf'));
delete from tab_operate where resource_uuid in('8e059c578c204fbbb29086aa72ec88f9','0b62d21d1ecd471f958d96b43471dcca','cd98d21d1ecd471f958d96b43471bbbf');
delete from tab_role_resource where resource_id in('8e059c578c204fbbb29086aa72ec88f9','0b62d21d1ecd471f958d96b43471dcca','cd98d21d1ecd471f958d96b43471bbbf');
delete from tab_resource where uuid in('8e059c578c204fbbb29086aa72ec88f9','0b62d21d1ecd471f958d96b43471dcca','cd98d21d1ecd471f958d96b43471bbbf');
...
insert into tab_resource (uuid, resource_name, resource_type, resource_url, parent_resource_uuid, creator_name, create_time, remark,ordernum,is_view) values
('cd98d21d1ecd471f958d96b43471bbbf','法律人员',3,'/website/backstage/InfoReleaseController.do?method=infoReleaseList&oneLevelClassify=16','8e059c578c204fbbb29086aa72ec88f9','admin',str_to_date('2021-07-04','%Y-%m-%d %T'),'工作发布菜单',24,1);
...
insert into tab_role_resource (role_id, resource_id) values ('efb74820f0564d02bb68fdf3190a6430', 'cd98d21d1ecd471f958d96b43471bbbf');
...
insert into tab_operate (uuid, resource_uuid, privilege_uuid,fun_class,fun_method,operate_name,operate_desc,ordernum,OPERATE_NO) values
('5a9eb8f7483240cc9da4555a10440245','cd98d21d1ecd471f958d96b43471bbbf','756d6e80c9d74b4389c918ab50ee19c3',
...
insert into tab_operate (uuid, resource_uuid, privilege_uuid,fun_class,fun_method,operate_name,operate_desc,ordernum,OPERATE_NO) values
('3b12648e06924d0897c3fa2cb920e165','cd98d21d1ecd471f958d96b43471bbbf','dec3b327b8a54d66bd644c544ea65c5e',
...
insert into tab_operate (uuid, resource_uuid, privilege_uuid,fun_class,fun_method,operate_name,operate_desc,ordernum,OPERATE_NO) values
('d2ae7226856f4debade44aafb5d0247c','cd98d21d1ecd471f958d96b43471bbbf','022a43088dcd46d4b201b43b32d3d85a',
...
insert into tab_operate (uuid, resource_uuid, privilege_uuid,fun_class,fun_method,operate_name,operate_desc,ordernum,OPERATE_NO) values
('b2124a5d6a2540d7b58ef851c8b198f8','cd98d21d1ecd471f958d96b43471bbbf','fe755fa4bd25475fa1a9d841caa16f44',
...
insert into tab_operate (uuid, resource_uuid, privilege_uuid,fun_class,fun_method,operate_name,operate_desc,ordernum,OPERATE_NO) values
('fa25528cca6b41c48048532ae3c5bba5','cd98d21d1ecd471f958d96b43471bbbf','022a43088dcd46d4b201b43b32d3d85a',
...
insert into tab_operate (uuid, resource_uuid, privilege_uuid,fun_class,fun_method,operate_name,operate_desc,ordernum,OPERATE_NO) values
('1b4ccd2a2f0a416d9a1bae77c6353e18','cd98d21d1ecd471f958d96b43471bbbf','607e8bc6f9bb4afa9be3cfdc72a1a326',
...
insert into tab_operate (uuid, resource_uuid, privilege_uuid,fun_class,fun_method,operate_name,operate_desc,ordernum,OPERATE_NO) values
('dc639064ff504f3aaa702bf19c7aee95','cd98d21d1ecd471f958d96b43471bbbf','cb14b0e3d47647e58da01ab09e0d373c',
'priv.guochun.psmc.website.backstage.InfoRelease.service.InfoReleaseService','executeUndoBusinessMethod','撤销','撤销',1,'LEGAL_PROVISIONS_UNDO');
