...
INSERT INTO TAB_DATA_DICT(ID,DICT_ID,DICT_NAME,REMARK,DICT_TYPE,ORDERNUM,DICT_NO,PARENT_DICT_TYPE) VALUES('4e3c9e85ed974b54a955497303de9610','1','网格总量测算','测算规则',24,3,'RULE_TYPE',NULL);
...
INSERT INTO TAB_DATA_DICT(ID,DICT_ID,DICT_NAME,REMARK,DICT_TYPE,ORDERNUM,DICT_NO,PARENT_DICT_TYPE) VALUES('c337654571864eb98f2cdba89a32fdc3','4','中小学距离测算','测算规则',24,1,'RULE_TYPE',NULL);
INSERT INTO TAB_DATA_DICT(ID,DICT_ID,DICT_NAME,REMARK,DICT_TYPE,ORDERNUM,DICT_NO,PARENT_DICT_TYPE) VALUES('c337654571864eb98f2cdba89a32fdc3','5','幼儿园距离测算','测算规则',24,2,'RULE_TYPE',NULL);
...
delete from TAB_DATA_DICT where DICT_NO='GRID_TYPE';
INSERT INTO TAB_DATA_DICT(ID,DICT_ID,DICT_NAME,REMARK,DICT_TYPE,ORDERNUM,DICT_NO,PARENT_DICT_TYPE) VALUES('b069f61924c642569dc3cab4d6f4a051','1','实际网格','实际网格',32,1,'GRID_TYPE',NULL);
INSERT INTO TAB_DATA_DICT(ID,DICT_ID,DICT_NAME,REMARK,DICT_TYPE,ORDERNUM,DICT_NO,PARENT_DICT_TYPE) VALUES('cc5f4f4d4de74211a69b1b676a1092b6','2','虚拟网格','虚拟网格',32,2,'GRID_TYPE',NULL);
