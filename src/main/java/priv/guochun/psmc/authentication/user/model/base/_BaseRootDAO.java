...
public abstract class _BaseRootDAO {
	...
	public static void initialize () {
		priv.guochun.psmc.authentication.user.model.dao._RootDAO.initialize(
			(String) null);
	}
	...
	public static void initialize (String configFileName) {
		priv.guochun.psmc.authentication.user.model.dao._RootDAO.initialize(
			configFileName,
			priv.guochun.psmc.authentication.user.model.dao._RootDAO.getNewConfiguration(
				null));
	}
	...
	public static void initialize (String configFileName, Configuration configuration) {
		if (null != sessionFactoryMap && null != sessionFactoryMap.get(configFileName)) return;
			...
			if (null == configFileName) {
				...
				priv.guochun.psmc.authentication.user.model.dao._RootDAO.setSessionFactory(
					null,
