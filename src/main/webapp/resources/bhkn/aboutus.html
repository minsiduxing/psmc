		...
		<nav class="fh5co-nav-style-1" role="navigation" data-offcanvass-position="fh5co-offcanvass-left">
			<div class="container">
				<div class="col-lg-2 col-md-3 col-sm-3 col-xs-12 fh5co-logo">
					...
					<a href="#" class="wow fadeInUp"  data-wow-duration="1s" data-wow-delay="0.5s">关于我们</a>
				</div>
					...
					<div class="row">
						<div>
							<div class="fh5co-cover-intro">
								<h1 class="cover-text-lead wow fadeInUp" data-wow-duration="1s" data-wow-delay="1.5s">公司介绍</h1>
								<span class="companyEN">COMPANY INTRODUCTION</span>
