$(document).ready(function(){
    ...
    var waitQueueCfgOption = {
        ...
        columns:[[
            ...
            {field:'workTime',title:'工作时间',width:$(this).width() * 0.3},
            {field:'isFictitiousGrid',title:'启用虚拟网格',width:$(this).width() * 0.2,align:'center',formatter: function (value, row, index) {
                    if(value == 1){
                        return "是";
                    }else{
                        return "否";
            ...
            {field:'overdueDays',title:'排队超期工作日',align:'center',width:$(this).width() * 0.2},
            {field:'isClosedRetain',title:'启用歇业保留',width:$(this).width() * 0.2,align:'center',formatter: function (value, row, index) {
                    if(value == 1){
                        return "是";
                    }else{
                        return "否";
