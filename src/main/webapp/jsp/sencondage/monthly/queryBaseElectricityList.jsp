...
<input type="hidden" id="checkFlag" value="0"/>
			...
			<c:forEach items="${mypage.dataList}" var="info">
					<tr>
						...
						<td class="td"><c:out value="${info.FILE_INPUT_DATE_CHAR}"/></td>
						...
						<td class="td">
							...
							<button id="queryButton" type="button" class="button" onclick="newFun('edit','${info.ELECID}','${info.FILE_INPUT_DATE}');">编辑</button>
						</td>
					</tr>
			</c:forEach>
			</tbody>
