...
function exportInfo(){
	 var url  = '<c:url value="/sencondage/tabBaseElectricController.do?method=exportAloneSitStatisticsReportList"/>';
	 $("#queryForm").attr("action",url);
	 $("#queryForm").submit();
}
function queryInfo(){
	$("#queryForm").attr("action",'<c:url value="/sencondage/tabBaseElectricController.do?method=queryAloneSitStatisticsReportList"/>');
	$("#queryForm").submit();
