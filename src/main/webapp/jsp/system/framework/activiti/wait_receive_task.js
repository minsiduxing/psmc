...
$(document).ready(function(){
	var option = {
		...
		columns:[[
				...
				{field:'task_process_name',align:'center',title:"待处理人",width:$(this).width() * 0.2},
				{field:'task_process_group',align:'center',title:"待处理组",width:$(this).width() * 0.2},
				{field:'task_process_role',align:'center',title:"待处理角色",width:$(this).width() * 0.2},
				...
				{field:' ',align:'center',title:"操作",width:$(this).width() * 0.2,formatter: function (value, row, index) {
					return "<a href='javascript:void(0)' onclick='claimTask(&apos;" + row['task_id'] + "&apos;)'>领取</a>";
				}}
			]
		]
	};
